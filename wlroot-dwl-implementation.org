...
| xdg-desktop-portal-hyprland        | supporto portal per Hyprland                        |
|                                    | Tiling composite manager                            |
| xdg-desktop-portal-termfilechooser | supporto portal per il                              |
|                                    | term-file-chooser si associ in wlroots              |
| *xdg-desktop-portal-wlr*           | supporto portal per wlroots (sway, dwl, velox, etc) |
| xdg-desktop-portal-xapp            | supporto portal per xapp,                           |
|                                    | tipicamente si utilizza per Cinnamon                |
